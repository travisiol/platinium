...
export const metadata: Metadata = {
  ...
  title: {
    default: `${siteConfig.name} — Trade Memes. Stack Platinum.`,
  ...
  openGraph: {
    title: `${siteConfig.name} — Trade Memes. Stack Platinum.`,
    description: siteConfig.seoDescription,
    url: siteConfig.url,
...
export default function RootLayout({ children }: LayoutProps<"/">) {
  return (
    <html lang="en" className="h-full antialiased">
      ...
      <body className="min-h-full flex flex-col bg-ink text-ice">
        <Providers>
          <Navbar />
